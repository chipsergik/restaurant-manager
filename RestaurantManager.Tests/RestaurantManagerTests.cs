...
public class RestaurantManagerTests
{
        ...
        int groupSize)
    {
        ...
        restaurantManager.ProcessQueue();
    ...
    public void ProcessQueue_WhenAllTablesAreEmptyAndClientsGroupsInQueue_clientsGroupsQueueShouldBeProcessedInOrder()
    {
        ...
        var clientGroupInQueue5 = CreateClientsGroup(size: 2);
        ...
        var actualTableSize5 = restaurantManager.Lookup(clientGroupInQueue5.Id)?.Size;
    ...
    public void ProcessQueue_WhenOnlyPartiallyEmptyTableAvailable_ClientsGroupShouldChoosePartiallyEmptyTable()
    {
        ...
        var clientsGroupInQueue = CreateClientsGroup(2);
        ...
        var actualTableSize = restaurantManager.Lookup(clientsGroupInQueue.Id)?.Size;
    ...
    public void ProcessQueue_WhenPartiallyEmptyAndEmptyTablesAvailable_ClientsGroupShouldChooseEmptyTable()
    {
        ...
        var actualTableSize = restaurantManager.Lookup(arrivedClientsGroup.Id)?.Size;
    ...
    public void ProcessQueue_WhenGroupInQueueCantBeProcessedAndArrivedGroupCanBeProcessed_ShouldProcessArrivedGroup()
    {
        ...
        var actualTableSize2 = restaurantManager.Lookup(arrivedClientsGroup.Id)?.Size;
